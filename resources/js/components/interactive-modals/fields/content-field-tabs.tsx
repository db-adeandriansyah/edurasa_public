...
export default function ContentFieldTabsForm({
        contentFields,
        currentData,
        mode,
        setCurrentData,
    ...
    return ( <Tabs>
                ...
                {
                    layoutingTabs?.map((tabContent, index)=>
...
export function ContentFieldTabsFormOnly({
    ...
    return ( <Tabs>
                ...
                </TabsList>
                {
                    layoutingTabs?.map((tabContent, index)=>
                        <TabsContent key={index} value={tabContent.value} className="border-t-2 rounded-3xl rounded-s-none pt-2 dark:border-sky-700">
                            <GroupContentOnly layoutingTabsOnly={layoutingTabsOnly} groupContent={tabContent?.groupContents} contentFields={contentFields} currentData={currentData} setCurrentData={setCurrentData}/>
                        </TabsContent>
                    )
                }
            </Tabs>
