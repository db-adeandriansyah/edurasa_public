...
export default function MyLogo(){
    return(
        <div className="absolute rounded-2xl text-center top-0 bottom-0 border shadow-lg bg-white dark:bg-black l md:left-1/2 md:-translate-x-6 w-[54px] h-[54px] my-1">
